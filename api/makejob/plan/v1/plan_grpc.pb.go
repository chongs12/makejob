...
func (c *planServiceClient) UpdateTaskStatus(ctx context.Context, in *UpdateTaskStatusRequest, opts ...grpc.CallOption) (*TaskDetail, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TaskDetail)
...
func (UnimplementedPlanServiceServer) UpdateTaskStatus(context.Context, *UpdateTaskStatusRequest) (*TaskDetail, error) {
...
var PlanService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "makejob/plan/v1/plan.proto",
}
