...
type QuestionServiceClient interface {
	...
	// --- 智能推荐 ---
	GetPracticeRecommendations(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*PracticeRecommendationResponse, error)
...
func (c *questionServiceClient) GetPracticeRecommendations(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*PracticeRecommendationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type QuestionServiceServer interface {
	...
	// --- 智能推荐 ---
	GetPracticeRecommendations(context.Context, *UserIDRequest) (*PracticeRecommendationResponse, error)
...
func (UnimplementedQuestionServiceServer) GetPracticeRecommendations(context.Context, *UserIDRequest) (*PracticeRecommendationResponse, error) {
...
func _QuestionService_GetPracticeRecommendations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuestionServiceServer).GetPracticeRecommendations(ctx, req.(*UserIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
