...
const (
	UserService_Register_FullMethodName            = "/makejob.user.v1.UserService/Register"
	UserService_Login_FullMethodName               = "/makejob.user.v1.UserService/Login"
	UserService_RefreshToken_FullMethodName        = "/makejob.user.v1.UserService/RefreshToken"
	UserService_GetProfile_FullMethodName          = "/makejob.user.v1.UserService/GetProfile"
	UserService_UpdateProfile_FullMethodName       = "/makejob.user.v1.UserService/UpdateProfile"
	UserService_GetUserByID_FullMethodName         = "/makejob.user.v1.UserService/GetUserByID"
	UserService_BatchGetUsers_FullMethodName       = "/makejob.user.v1.UserService/BatchGetUsers"
...
type UserServiceClient interface {
	...
	GetUserByID(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*UserProfile, error)
...
func (c *userServiceClient) GetUserByID(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*UserProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserProfile)
...
func (c *userServiceClient) GetMembershipStatus(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*MembershipStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MembershipStatus)
	err := c.cc.Invoke(ctx, UserService_GetMembershipStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) UpgradeMembership(ctx context.Context, in *UpgradeRequest, opts ...grpc.CallOption) (*MembershipStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MembershipStatus)
	err := c.cc.Invoke(ctx, UserService_UpgradeMembership_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetUserByID(context.Context, *UserIDRequest) (*UserProfile, error)
...
func (UnimplementedUserServiceServer) GetUserByID(context.Context, *UserIDRequest) (*UserProfile, error) {
...
func (UnimplementedUserServiceServer) GetMembershipStatus(context.Context, *UserIDRequest) (*MembershipStatus, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMembershipStatus not implemented")
}
func (UnimplementedUserServiceServer) UpgradeMembership(context.Context, *UpgradeRequest) (*MembershipStatus, error) {
...
func _UserService_GetMembershipStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetMembershipStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetMembershipStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetMembershipStatus(ctx, req.(*UserIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_UpgradeMembership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpgradeMembership_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpgradeMembership(ctx, req.(*UpgradeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "makejob.user.v1.UserService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetMembershipStatus_Handler,
		},
		{
	...
	Metadata: "makejob/user/v1/user.proto",
}
