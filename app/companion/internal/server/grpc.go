...
func NewGRPCServer(
	cfg *conf.Server,
	companionSvc *service.CompanionService,
	...
	// 设置 gRPC 超时，默认 3 分钟（陪伴对话依赖 AI Gateway LLM 调用，耗时较长）
	...
	companionv1.RegisterCompanionServiceServer(srv.Server, companionSvc)
	return srv
}
